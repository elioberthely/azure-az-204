...
10) Ejecute el siguiente comando para obtener el documentEndpoint de la cuenta de Azure Cosmos DB. Anote el endpoint que aparece en los resultados del comando, ya que se necesitará más adelante en el ejercicio."

    ### az cosmosdb show --name $accountName \
    --resource-group $resourceGroup \
    --query "documentEndpoint" --output tsv

11) Nos devuelve el valor
    https://cosmosexercise10126.documents.azure.com:443/

    ### Azure CLI te devolvió esta URL, que es el endpoint o dirección principal para conectarte a tu cuenta de Azure Cosmos DB.


12) Corra este comando 
    ...
    Y Obtenga la clave primaria de la cuenta con el siguiente comando. Anote la clave primaria que aparece en los resultados del comando, ya que se necesitará más adelante en el ejercicio.

13) Esto nos devuelve una llave primaria

    ayRVHv7tcDnoSIKDZh2fkCTi8g8xsjkSCecHqN9CyC2MorACDbetFcmg==
